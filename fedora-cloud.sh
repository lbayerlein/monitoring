...
#Variables
packages="nagios pnp4nagios nagios-plugins-all mod_python httpd xinetd wget gcc gcc-c++ make php-gd php-pdo php-mbstring php-session php-gettext php-php-gettext php-xml php graphviz graphviz-gd graphviz-devel php-pear-Image-GraphViz check_mk" 
